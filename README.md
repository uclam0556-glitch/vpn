...
- фактическая проверка подписки от имени Happ после выдачи и продления;
- автоматическое восстановление пользователя, Squad и срока одной кнопкой;
- мониторинг количества доступных серверов и TCP-доступности нод;
